...
class GitHandler:
    ...
    def clone_repository(self, github_url: str, target_dir: Optional[str] = None) -> str:
    ...
    def find_java_files(self, repo_path: str) -> List[str]:
        ...
        for java_file in repo_path.rglob("*.java"):
            ...
            skip_dirs = {
                '.git', 'target', 'build', 'bin', 'out', 
                'node_modules', '.gradle', '.mvn', '.github'
            }
    ...
    def get_repository_info(self, repo_path: str, original_url: str = None) -> Dict[str, Any]:
        ...
        info = {
            "path": repo_path,
            "name": self._extract_repo_name_from_url(original_url) if original_url else Path(repo_path).name,
            "java_files": [],
            "java_file_count": 0
        }
