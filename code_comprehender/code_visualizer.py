...
class CodeVisualizer:
    ...
    def analyze_code_architecture(self, java_file_path: str) -> Dict[str, Any]:
        ...
        for i, chunk in enumerate(chunks):
            log_progress(f"Analyzing chunk: {chunk.name} ({chunk.token_count:,} tokens)", i + 1, len(chunks))
    ...
    def _analyze_chunk_with_llm(self, code: str) -> Dict[str, Any]:
        ...
        try:
            ...
            messages = [
                ...
                HumanMessage(content=f"Analyze this code for architectural relationships:\n\n{code}")
            ]
    ...
    def analyze_file_structure(self, java_file_path: str) -> Dict[str, Any]:
        ...
        analysis = self.analyze_code_architecture(java_file_path)
    ...
    def process_file(self, java_file_path: str, output_dir: str = "output") -> Tuple[str, str]:
